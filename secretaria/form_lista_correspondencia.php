...
<p>
	...
	$query = "SELECT * FROM corres  inner join planteles on corres.id_plantel= planteles.id_plantel   where no_trabajador = $y "  ;
 ...
 echo  '<table width="100%" id="tabla" border="1" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <th width="20%"><div align="center">Nombre </div></th>
             <th width="20%"><div align="center">Destino</div></th>
             <th width="20%"><div align="center">STATUS </div></th>

            <th width="10%"><div align="center">Entregas </div></th>
...
while($row=mysql_fetch_array($Resultado)){
	...
	if ($row['status'] == 1 ){
        ...
        echo  '<tr>
			...
			<td align="center" ><a href="entregas.php?correspondencia='.$row['id_corres'].'"><img src="images/maquina.png" width="25" height="25"> </a></td>
